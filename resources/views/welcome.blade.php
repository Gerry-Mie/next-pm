            ...
            <div class="banner-wrapper justify-content-between">
                ...
                <div class="banner-thumb">
                    <img class="wow animate__dropIn"
                         src="{{ $topImageData['top_image_1'] }}" alt="{{translate('banner')}}">
                    <img class="wow animate__dropIn"
                         src="{{ $topImageData['top_image_2'] }}" alt="{{translate('banner')}}">
                    <img class="wow animate__dropIn"
                         src="{{ $topImageData['top_image_3'] }}" alt="{{translate('banner')}}">
                    <img class="wow animate__dropIn"
                         src="{{ $topImageData['top_image_4'] }}" alt="{{translate('banner')}}">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="cta-main">
                ...
                <div class="cta-wrapper bg__img" data-img="{{asset('public/assets/landing')}}/img/cta-bg.png">
                    <img width="238" src="{{ $providerSectionImage }}" alt="{{translate('image')}}" class="left-icon">
