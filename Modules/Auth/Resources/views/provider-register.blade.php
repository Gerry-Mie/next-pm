        ...
        $(document).ready(function () {
            ...
            $('#sameAsGI').on('change', function() {
                if ($(this).is(':checked')) {
                    ...
                    $('.country-picker-2').find('.iti__selected-dial-code').text($('.country-picker-1 .iti__selected-dial-code').text())
                    $('.country-picker-2').find('.iti__flag').attr('class', $('.country-picker-1').find('.iti__flag').attr('class'))
                } else {
