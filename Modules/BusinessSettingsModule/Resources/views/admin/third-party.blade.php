...
{{--                                                        <a href="#" class="c1 text-decoration-underline" data-bs-toggle="tooltip" title="At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium atum deleniti atque.">{{ translate('Learn more') }}</a>--}}
{{--                                                    </div>--}}
                                                </div>
                                            </div>
                                        </div>
