                        ...
                        <div class="card border shadow-none">
                            <div class="card-body">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        <div class="form-floating form-floating__icon mb-30">
                                            <input type="number" class="form-control" name="price" value="{{ old('price') }}" min="0.01" step=".01" placeholder="{{ translate('price') }}" required="">
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        <div class="form-floating form-floating__icon mb-30">
                                            <input type="number" class="form-control" name="duration" value="{{ old('duration') }}" placeholder="duration" min="1" max="999999999" required="">
