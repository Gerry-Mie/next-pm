    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="bg-light p-30 rounded">
                        <div class="d-flex flex-column gap-3 align-items-center text-center mb-4">
                        ...
                        <div class="d-flex flex-wrap gap-3 justify-content-center">
                            <a class="btn btn--secondary text-capitalize db-backup db-download"
                            ...
                            @can('backup_view')
                                <a class="btn btn--primary db-backup text-capitalize"
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="bg-light p-30 rounded">
                        <div class="d-flex flex-column gap-3 align-items-start text-start mb-4">
                        ...
                        <div class="d-flex flex-wrap gap-3 justify-content-start">
                            <form action="{{route('admin.business-settings.database-backup.update-binary-path')}}" method="post">
                                ...
                                <div class="form-group">
                                    <label>
                                        <input type="text" name="binary_path" value="{{env('DUMP_BINARY_PATH')}}" class="form-control"
                                               placeholder="{{ translate('/usr/bin') }}">
                                    </label>
                                    <button type="submit"
                                            class="btn btn--primary radius-button text-end">{{translate('Update')}}</button>
                                </div>
                            </form>
                        </div>
                    </div>
                                    ...
                                    @canany(['backup_delete', 'backup_export', 'backup_add'])
                                        <td>
                                            <div class="d-flex gap-2 justify-content-center">
                                                @can('backup_add')
                                                    <button type="button" class="action-btn btn--light-primary db-restore"
                                                            data-bs-toggle="modal" data-bs-target="#restoreModal_{{$key}}" title="{{ translate('Restore') }}">
                                                                ...
                                                                <div class="modal-body p-30">
                                                                    ...
                                                                    <div class="d-flex flex-column gap-2 align-items-center text-center">
                                                                        ...
                                                                        <div class="d-flex gap-3 justify-content-center flex-wrap">
                                                                            ...
                                                                            <a class="btn btn--primary text-capitalize" href="{{route('admin.business-settings.restore-database-backup',[$file['name']])}}">{{ translate('Restore Backup') }}</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                @endcan
                                                @can('backup_export')
                                                        <button type="button" class="action-btn btn--success db-backup" title="{{ translate('Download') }}"
                                                ...
                                                @endcan
                                                @can('backup_export')
                                                        <button type="button" class="action-btn btn--danger db-backup" title="{{ translate('Remove') }}"
