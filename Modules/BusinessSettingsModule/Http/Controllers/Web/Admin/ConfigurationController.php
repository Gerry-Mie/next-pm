...
class ConfigurationController extends Controller
{
    ...
    public function thirdPartyConfigGet(Request $request): View|Factory|Application
    {
        $this->authorize('configuration_view');
        $request->validate([
            'web_page' => 'required|in:google_map,recaptcha,push_notification,apple_login,email_config,sms_config,payment_config,app_settings,social_login,test_mail,storage_connection'
        ]);
