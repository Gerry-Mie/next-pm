...
class ProviderController extends Controller
{
    ...
    public function __construct(Provider $provider, Category $category, SubscribedService $subscribed_service, Booking $booking, Service $service, Variation $variation, FavoriteProvider $favoriteProvider, Request $request)
    {
