                                ...
                                <div class="row mt-3">
                                        ...
                                        <div class="mb-30">
                                            <div class="form-floating form-floating__icon">
                                                <input
                                                    ...
                                                    data-bs-custom-class="custom-tooltip"
                                                    data-bs-title="{{translate('Not_editable')}}" readonly>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-floating mb-30">
                                            ...
                                            <div class="">
                                                <input type="text" class="country-picker-phone-number w-50" value="{{old('contact_person_phone')}}" name="contact_person_phone" hidden  readonly>
                                            </div>
                                        </div>
                                        <div class="form-floating form-floating__icon mb-30">
