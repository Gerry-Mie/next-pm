                            ...
                            <div class="row">
                                <div class="col-md-6" id="register-form-p-0">
                                    ...
                                    <div class="form-floating mb-30">
                                        ...
                                        <input type="tel" class="form-control company_phone phone-input-with-country-picker iti__tel-input" id="company_phone"
                                            ...
                                            <div class="row gx-2">
                                                <div class="col-lg-6">
                                                    <div class="form-floating mb-30">
                                                        ...
                                                        <input type="tel" class="form-control phone-input-with-country-picker2 iti__tel-input"
                                    ...
                                    <div class="mb-30">
                                        <div class="form-floating form-floating__icon">
                                            <input type="tel" class="form-control"
                                                   ...
                                                   id="account_phone" readonly required>
