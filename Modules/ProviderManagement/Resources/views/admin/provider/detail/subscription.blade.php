                            ...
                            <div class="c1-light-bg radius-10 p-lg-4 p-3">
                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-30">
                                    <div class="">
                                        ...
                                        <h5 class="">{{ translate('Provider will pay')}} {{ $commission }}% {{ translate('commission to Demandium from each order. You will get access of all the features and options  in store panel , app and interaction with user.') }}</h5>
                                    </div>
                                </div>
                            </div>
