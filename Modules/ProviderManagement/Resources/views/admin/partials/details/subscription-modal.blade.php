                            ...
                            <div class="price-box d-flex flex-column rounded-3 border">
                                ...
                                <div class="p-3 flex-grow-1 d-flex flex-column">
                                    <div class="text-center mb-30 fs-12">
                                        {{translate('Provider will pay ')}}{{$commission}}% {{translate('commission to Admin from each order. You will get access of all the features and options  in provider panel , app and interaction with user.')}}
                                    </div>
