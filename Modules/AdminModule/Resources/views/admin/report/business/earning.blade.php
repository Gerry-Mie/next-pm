                    ...
                    <div class="d-flex flex-column gap-3">
                        ...
                        <div class="card flex-row gap-4 p-30">
                            <div class="d-flex gap-4 flex-wrap">
                                ...
                                <div>
                                    <h2 class="fz-26">{{with_currency_symbol(array_sum($chart_data['earning_amount']))}}</h2>
    ...
    <script>
        ...
        var options = {
            series: [
                ...
                {
                    name: "{{translate('earning_amount')}}",
                    data: {{json_encode(array_merge($chart_data['earning_amount']))}}
                }
            ],
            chart: {
                height: 290,
