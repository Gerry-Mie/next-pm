...
class ServiceController extends Controller
{
    ...
    public function __construct(Service $service, Review $review, SubscribedService $subscribed_service, Category $category, Booking $booking, Faq $faq, PackageSubscriber $packageSubscriber, PackageSubscriberLimit $packageSubscriberLimit)
    {
