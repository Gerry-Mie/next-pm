...
function initializePhoneInput(selector, outputSelector) {
    ...
    const initialCountry = countryCodeMatch ? `+${countryCodeMatch}` : 'bn'.toLowerCase();
...
$(document).ready(function() {
    try {
        ...
        initializePhoneInput(".phone-input-with-country-picker2", ".country-picker-phone-number2");
    } catch (error) {}
});
